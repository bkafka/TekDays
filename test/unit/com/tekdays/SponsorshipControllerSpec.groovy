...
@Mock([Sponsorship,TekEvent,Sponsor])
class SponsorshipControllerSpec extends Specification {
    ...
    void "Test the save action correctly persists an instance"() {
        ...
        when:"The save action is executed with an invalid instance"
            ...
            request.method = 'POST'
            def sponsorship = new Sponsorship(['event':new TekEvent(), 'sponsor':new Sponsor(),'contributionType':'Other'])
        sponsorship.save()
...
//            model.sponsorshipInstance!= null
        ...
        when:"The save action is executed with a valid instance"
            response.reset()
            populateValidParams(['event':new TekEvent(), 'sponsor':new Sponsor(),'contributionType':'Other'])
